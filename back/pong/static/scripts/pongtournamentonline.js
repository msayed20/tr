...
function runsocket(){
    ...
    function draw_objects(){
        if (data && data.data && data.data.tournament.status === "Waiting") // start of the tournament
        {
            ctx.fillStyle = 'black'
        ...
        else if (data && data.data && data.data.tournament.timer >= 0) //between each match
        {
            ctx.fillStyle = 'black'
            ctx.fillRect(0, 0, canvas.width, canvas.height);
            ctx.fillStyle = 'white';
        ...
        else if (data && data.data && data.data.player_status == 'Qualified') //between each match
        {
            ctx.fillStyle = 'black'
            ctx.fillRect(0, 0, canvas.width, canvas.height);
            ctx.fillStyle = 'white';
        ...
        else if (data && data.data && data.data.player_status == 'Disqualified') //between each match
        {
            ctx.fillStyle = 'black'
            ctx.fillRect(0, 0, canvas.width, canvas.height);
            ctx.fillStyle = 'white';
    ...
    function draw(){
        ...
        else if (running == false) //end of the tournament
        {
            ctx.fillStyle = 'black'
            ctx.fillRect(0, 0, canvas.width, canvas.height);
            ctx.fillStyle = 'white';
